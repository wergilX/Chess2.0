...
std::vector<std::pair<int, int>> RookMoveStrategy::GetValidMoves(int x, int y, const std::vector<int>& board)
{
	std::vector<std::pair<int, int>> valid_moves;

	auto part_of_valid_moves = ChekDirection(x, y, 1, 0, board);
	valid_moves = part_of_valid_moves;

	part_of_valid_moves = ChekDirection(x, y, -1, 0, board);
	valid_moves.insert(valid_moves.end(), part_of_valid_moves.begin(), part_of_valid_moves.end());

	part_of_valid_moves = ChekDirection(x, y, 0, 1, board);
	valid_moves.insert(valid_moves.end(), part_of_valid_moves.begin(), part_of_valid_moves.end());
...
std::vector<std::pair<int, int>> RookMoveStrategy::ChekDirection(int x, int y, int dirX, int dirY, const std::vector<int>& board)
{
	std::vector<std::pair<int, int>> valid_moves;
